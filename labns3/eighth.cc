...
// - pcap tracing available when tracing is turned on.
...
NS_LOG_COMPONENT_DEFINE ("eighth");
...
//
  ...
  NS_LOG_INFO ("Create channels.");
	...
	//Add random fuzz to channel delay start time
	double min = 50.0;
	double max = 500.0;
	...
	auto delayStr = std::to_string(fuzz->GetValue()); 
...
//
  ...
  pointToPoint.SetChannelAttribute ("Delay", StringValue (delayStr + "ms"));

  std::cout << "Delay of channel: " << delayStr + "ms" << std::endl;
